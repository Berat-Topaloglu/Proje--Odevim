...
export default function CompanyProfile() {
    ...
    const { 
        loading: saving, // Map 'saving' to loading
    ...
    return (
        <div className="page-wrapper">
            <div className="content-wrapper page-enter" style={{ maxWidth: 850 }}>
                ...
                {/* Photo Modal */}
                {showPhotoModal && (
                    <div className="modal-overlay" onClick={() => { stopCamera(); setPreviewPhoto(null); clearStatus(); setShowPhotoModal(false); }}>
                        <div className="modal-content photo-modal company-modal card" onClick={e => e.stopPropagation()}>
                            <h3>Şirket Logosu</h3>
                            {modalError && <div className="alert alert-error mb-16 mt-16">{modalError}</div>}
